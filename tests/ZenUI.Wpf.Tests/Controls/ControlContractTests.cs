...
namespace ZenUI.Wpf.Tests.Controls
{
    ...
    public class ControlContractTests
    {
        ...
        public void GenericThemeContainsControlStylesAndTokens()
        {
            ...
            Assert.AreEqual(7d, dictionary["ZenScrollBarThickness"]);
            Assert.AreEqual(7d, dictionary["ZenScrollBarTrackThickness"]);
            Assert.AreEqual(32d, dictionary["ZenScrollBarThumbMinLength"]);
            Assert.AreEqual(new Thickness(0), dictionary["ZenVerticalScrollBarMargin"]);
            Assert.AreEqual(new Thickness(0), dictionary["ZenHorizontalScrollBarMargin"]);
            Assert.AreEqual(new Thickness(0), dictionary["ZenVerticalScrollBarTrackMargin"]);
            Assert.AreEqual(new Thickness(0), dictionary["ZenHorizontalScrollBarTrackMargin"]);
            Assert.AreEqual(new Thickness(0), dictionary["ZenVerticalScrollBarThumbMargin"]);
            Assert.AreEqual(new Thickness(0), dictionary["ZenHorizontalScrollBarThumbMargin"]);
