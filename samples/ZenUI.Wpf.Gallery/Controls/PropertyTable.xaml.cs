    ...
    public partial class PropertyTable : UserControl
    {
        ...
        private static readonly Dictionary<string, string> Descriptions =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ZenCheckBox.CheckMarkForeground"] = "勾号或不确定标记的前景画刷。",
        ...
        private static readonly Dictionary<string, string> PropertyVersionOverrides =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ["ZenAlert.AccentBrush"] = "0.1.0-preview.4",
                ...
                ["ZenCheckBox.CheckMarkForeground"] = UnreleasedPropertyVersion,
                ...
                ["ZenRadioButton.AccentBrush"] = "0.1.0-preview.4",
                ["ZenRadioButton.IndicatorSize"] = "0.1.0-preview.5",
                ["ZenRadioGroup.DisplayMode"] = "0.1.0-preview.7",
