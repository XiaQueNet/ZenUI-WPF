...
namespace ZenUI.Wpf.Gallery.Controls
{
    public partial class PropertyTable : UserControl
    {
        ...
        private static readonly Dictionary<string, string> PropertyVersionOverrides =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ["ZenAlert.IconBackground"] = UnreleasedPropertyVersion,
                ...
                ["ZenCheckBox.CheckedBackground"] = UnreleasedPropertyVersion,
                ["ZenCheckBox.CheckedBorderBrush"] = UnreleasedPropertyVersion,
                ["ZenCheckBox.HoverBorderBrush"] = UnreleasedPropertyVersion,
                ["ZenCheckBox.CheckedGlyphBrush"] = UnreleasedPropertyVersion,
                ...
                ["ZenNumberBox.Increment"] = UnreleasedPropertyVersion,
                ...
                ["ZenPopover.AnchorGap"] = UnreleasedPropertyVersion,
                ["ZenRadioButton.HoverBorderBrush"] = UnreleasedPropertyVersion,
                ["ZenRadioButton.CheckedBorderBrush"] = UnreleasedPropertyVersion,
                ["ZenRadioButton.CheckedGlyphBrush"] = UnreleasedPropertyVersion,
                ["ZenRadioButton.IndicatorSize"] = "0.1.0-preview.5",
                ["ZenRadioGroup.Appearance"] = UnreleasedPropertyVersion,
                ["ZenRadioGroup.IsItemSizeUniform"] = UnreleasedPropertyVersion,
                ["ZenRadioGroup.SelectionBrush"] = UnreleasedPropertyVersion,
