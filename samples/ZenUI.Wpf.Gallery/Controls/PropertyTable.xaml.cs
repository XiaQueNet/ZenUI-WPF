    ...
    public partial class PropertyTable : UserControl
    {
        ...
        private static readonly Dictionary<string, string> PropertyVersionOverrides =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ZenCheckBox.AccentBrush"] = "0.1.0-preview.4",
                ["ZenCheckBox.GlyphBrush"] = "0.1.0-preview.4",
                ...
                ["ZenDateTimePicker.CalendarWidth"] = "0.1.0-preview.8",
                ["ZenDateTimePicker.IconSize"] = "0.1.0-preview.8",
                ["ZenDateTimePicker.SelectionHeight"] = "0.1.0-preview.8",
                ["ZenDateTimePicker.TimeColumnWidth"] = "0.1.0-preview.8",
