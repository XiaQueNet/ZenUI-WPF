    ...
    public partial class PropertyTable : UserControl
    {
        ...
        private static readonly Dictionary<string, string> Descriptions =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ...
                ["ZenComboBox.ShowWatermarkOnFocus"] = "获得键盘焦点且没有选中项时是否仍显示水印。",
                ...
                ["ZenDatePicker.ShowWatermarkOnFocus"] = "获得键盘焦点且尚未选择日期时是否仍显示水印。",
                ...
                ["ZenDatePicker.CalendarCellWidth"] = "日历网格单元的宽度。",
                ["ZenDatePicker.CalendarCellHeight"] = "日历网格单元的高度。",
                ["ZenDatePicker.CalendarFontSize"] = "日历弹层内容的字号。",
                ["ZenDatePicker.DropDownButtonWidth"] = "下拉按钮点击区域的宽度。",
                ["ZenDatePicker.DropDownButtonHeight"] = "下拉按钮点击区域的高度。",
                ["ZenDatePicker.DropDownButtonIconSize"] = "下拉按钮中日历图标的边长。",
                ...
                ["ZenDateTimePicker.Watermark"] = "尚未选择日期时间时显示的水印。",
                ["ZenTimePicker.Watermark"] = "尚未选择时间时显示的水印。",
                ["ZenTimePicker.ShowWatermarkOnFocus"] = "获得键盘焦点且尚未选择时间时是否仍显示水印。",
                ["ZenDateTimePicker.ShowWatermarkOnFocus"] = "获得键盘焦点且尚未选择日期时间时是否仍显示水印。",
                ...
                ["ZenTimePicker.DropDownButtonWidth"] = "下拉按钮点击区域的宽度。",
                ["ZenTimePicker.DropDownButtonHeight"] = "下拉按钮点击区域的高度。",
                ["ZenTimePicker.DropDownButtonIconSize"] = "下拉按钮中时钟图标的边长。",
                ["ZenDateTimePicker.DropDownButtonWidth"] = "下拉按钮点击区域的宽度。",
                ["ZenDateTimePicker.DropDownButtonHeight"] = "下拉按钮点击区域的高度。",
                ["ZenDateTimePicker.DropDownButtonIconSize"] = "下拉按钮中日历图标的边长。",
                ...
                ["ZenPasswordBox.ShowWatermarkOnFocus"] = "获得键盘焦点且密码为空时是否仍显示水印。",
                ...
                ["ZenTextBox.Watermark"] = "无内容时显示的水印。",
                ["ZenTextBox.ShowWatermarkOnFocus"] = "获得键盘焦点且内容为空时是否仍显示水印。",
        ...
        private static readonly Dictionary<string, string> PropertyVersionOverrides =
            new Dictionary<string, string>(StringComparer.Ordinal)
            {
                ["ZenAlert.IconBackground"] = "0.1.0-preview.11",
                ...
                ["ZenCheckBox.CheckedBackground"] = "0.1.0-preview.11",
                ["ZenCheckBox.CheckedBorderBrush"] = "0.1.0-preview.11",
                ["ZenCheckBox.HoverBorderBrush"] = "0.1.0-preview.11",
                ["ZenCheckBox.CheckedGlyphBrush"] = "0.1.0-preview.11",
                ...
                ["ZenDatePicker.CalendarCellWidth"] = UnreleasedPropertyVersion,
                ["ZenDatePicker.CalendarCellHeight"] = UnreleasedPropertyVersion,
                ["ZenDatePicker.CalendarFontSize"] = "0.1.0-preview.4",
                ["ZenDatePicker.IsTextInputReadOnly"] = "0.1.0-preview.11",
                ["ZenDatePicker.ShowWatermarkOnFocus"] = UnreleasedPropertyVersion,
                ["ZenDatePicker.DropDownButtonWidth"] = UnreleasedPropertyVersion,
                ["ZenDatePicker.DropDownButtonHeight"] = UnreleasedPropertyVersion,
                ["ZenDatePicker.DropDownButtonIconSize"] = UnreleasedPropertyVersion,
                ["ZenDateTimePicker.DropDownHeight"] = "0.1.0-preview.8",
                ["ZenDateTimePicker.DropDownWidth"] = "0.1.0-preview.8",
                ["ZenDateTimePicker.DropDownButtonWidth"] = UnreleasedPropertyVersion,
                ["ZenDateTimePicker.DropDownButtonHeight"] = UnreleasedPropertyVersion,
                ["ZenDateTimePicker.DropDownButtonIconSize"] = "0.1.0-preview.11",
                ["ZenDateTimePicker.IsTextInputReadOnly"] = "0.1.0-preview.11",
                ["ZenDateTimePicker.Is24HourFormat"] = "0.1.0-preview.11",
                ["ZenDateTimePicker.ShowWatermarkOnFocus"] = UnreleasedPropertyVersion,
                ...
                ["ZenTimePicker.DropDownButtonWidth"] = UnreleasedPropertyVersion,
                ["ZenTimePicker.DropDownButtonHeight"] = UnreleasedPropertyVersion,
                ["ZenTimePicker.DropDownButtonIconSize"] = UnreleasedPropertyVersion,
                ["ZenTimePicker.ShowWatermarkOnFocus"] = UnreleasedPropertyVersion,
                ...
                ["ZenNumberBox.Increment"] = "0.1.0-preview.11",
                ...
                ["ZenPasswordBox.ShowWatermarkOnFocus"] = UnreleasedPropertyVersion,
                ...
                ["ZenPopover.AnchorGap"] = "0.1.0-preview.11",
                ["ZenRadioButton.HoverBorderBrush"] = "0.1.0-preview.11",
                ["ZenRadioButton.CheckedBorderBrush"] = "0.1.0-preview.11",
                ["ZenRadioButton.CheckedGlyphBrush"] = "0.1.0-preview.11",
                ["ZenRadioButton.IndicatorSize"] = "0.1.0-preview.5",
                ["ZenRadioGroup.Appearance"] = "0.1.0-preview.11",
                ["ZenRadioGroup.IsItemSizeUniform"] = "0.1.0-preview.11",
                ["ZenRadioGroup.SelectionBrush"] = "0.1.0-preview.11",
                ["ZenSlider.ThumbBrush"] = "0.1.0-preview.4",
                ["ZenSlider.HoverThumbBrush"] = "0.1.0-preview.11",
                ...
                ["ZenComboBox.ShowWatermarkOnFocus"] = UnreleasedPropertyVersion,
                ["ZenTextBox.LeadingContent"] = "0.1.0-preview.2",
                ["ZenTextBox.LeadingContentTemplate"] = "0.1.0-preview.2",
                ["ZenTextBox.ShowWatermarkOnFocus"] = UnreleasedPropertyVersion,
                ["ZenTextBox.TrailingContent"] = "0.1.0-preview.2",
                ["ZenTextBox.TrailingContentTemplate"] = "0.1.0-preview.2",
                ["ZenTimePicker.IsTextInputReadOnly"] = "0.1.0-preview.11",
                ["ZenTimePicker.Is24HourFormat"] = "0.1.0-preview.11",
            };
